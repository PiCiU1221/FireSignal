...
public class LoginPanel extends JPanel {
    ...
    public LoginPanel(MyFrame frame) {
        ...
        ImageIcon imageIcon = new ImageIcon(Objects.requireNonNull(getClass().getResource("../resources/images/siren_logo.png")));
        ...
        switchToLoginButton1.setBackground(GlobalVariables.BUTTON_BACKGROUND_COLOR);
