...
import main.resources.config.AlarmActionApiService;
...
public class MessagePanel extends JPanel {
    ...
    public MessagePanel(MyFrame frame) {
        ...
        declineButton.addActionListener(e -> {
            ...
            AlarmActionApiService.declineAlarm(Integer.parseInt(id), Integer.parseInt(firefighterId));
        ...
        acceptButton.addActionListener(e -> {
            ...
            AlarmActionApiService.acceptAlarm(Integer.parseInt(id), Integer.parseInt(firefighterId));
