...
public class AlarmDAO {
    /*
    public static List<utils.Alarm> getNewestAlarmsForFirefighter(int skip, int howMuch) {
        ...
        try (Connection connection = DatabaseUtils.getConnection()) {
            ...
            try (PreparedStatement statement = connection.prepareStatement(query)) {
                statement.setString(1, utils.SessionManager.getLoggedInUser());
                ...
                while (resultSet.next()) {
                    ...
                    utils.Alarm alarm = new utils.Alarm(alarmId, city, street, description, dateTime);
                    alarms.add(alarm);
                }
            }
    ...
    public static int getAlarmedFirefightersCount(int alarm_id) {
        ...
        try (Connection connection = DatabaseUtils.getConnection()) {
            ...
            // firesignal.Main query to count the firefighters based on the department_id and alarm_id
            ...
            try (PreparedStatement queryStatement = connection.prepareStatement(query)) {
                ...
                queryStatement.setString(1, utils.SessionManager.getLoggedInUser());
